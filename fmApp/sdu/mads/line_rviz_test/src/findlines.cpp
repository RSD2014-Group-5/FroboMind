...
FindLines::FindLines()
{
    ...
    velocity_pub = n.advertise<geometry_msgs::TwistStamped>("/fmCommand/cmd_vel", 10);
    laserScan = n.subscribe<sensor_msgs::LaserScan>("/base_scan", 10, &FindLines::laserScanCallback, this);
...
void FindLines::laserScanCallback(const sensor_msgs::LaserScan::ConstPtr& data)
{
    ...
    projector_.transformLaserScanToPointCloud("/base_laser_link", *data, pointCloud, tfListener_);
